...
$sql = "SELECT rutas.id, operadores.nombres AS operador_nombre, operadores.apellido_paterno AS apellido_paterno, operadores.apellido_materno AS apellido_materno, unidades.tipo AS unidad_tipo, unidades.placa AS unidad_placa, rutas.lugar_inicio, rutas.lugar_final, rutas.fecha_inicio, rutas.fecha_final, rutas.kilometraje_inicial, rutas.kilometraje_final, rutas.kilometraje_recorrido, rutas.observaciones FROM rutas
